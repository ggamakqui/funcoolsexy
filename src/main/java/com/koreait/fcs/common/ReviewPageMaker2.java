...
public class ReviewPageMaker2 {
	...
	public static String getPageView(String path, int page1, int page2, int recordPerPage, int totalRecord, int pNo) {
		...
		beginPageOfBlock = (int)(((page2 - 1) / pagePerBlock) * pagePerBlock) + 1;
		...
		if ( beginPageOfBlock < pagePerBlock ) {
			...
			sb.append("<a href='" + path + "?page2=" + (beginPageOfBlock - 1) + "&page1=" + page1 + "&pNo=" + pNo +  "'>◀</a>&nbsp;&nbsp;");
		}
		...
		for ( int p = beginPageOfBlock; p <= endPageOfBlock; p++ ) {
			if ( p == page2 ) {
				...
				sb.append("<a href='" + path + "?page2=" + p + "&page1=" + page1 + "&pNo=" + pNo + "'>" + p + "</a>&nbsp;&nbsp;");
			}
		}
		...
		if ( endPageOfBlock == totalPage ) {
			...
			sb.append("<a href='" + path + "?page2=" + (endPageOfBlock + 1) + "&page1=" + page1 + "&pNo=" + pNo + "'>▶</a>");
		}

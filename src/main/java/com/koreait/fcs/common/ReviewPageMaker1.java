...
public class ReviewPageMaker1 {

	public static String getPageView(String path, int page1, int page2, int recordPerPage, int totalRecord, int pNo) {
		...
		beginPageOfBlock = (int)(((page1 - 1) / pagePerBlock) * pagePerBlock) + 1;
		...
		if ( beginPageOfBlock < pagePerBlock ) {
			...
			sb.append("<a href='" + path + "?page1=" + (beginPageOfBlock - 1) + "&page2=" + page2 + "&pNo=" + pNo +  "'>◀</a>&nbsp;&nbsp;");
		}
		...
		for ( int p = beginPageOfBlock; p <= endPageOfBlock; p++ ) {
			if ( p == page1 ) {
				...
				sb.append("<a href='" + path + "?page1=" + p + "&page2=" + page2 +"&pNo=" + pNo + "'>" + p + "</a>&nbsp;&nbsp;");
			}
		}
		...
		if ( endPageOfBlock == totalPage ) {
			...
			sb.append("<a href='" + path + "?page1=" + (endPageOfBlock + 1) + "&page2=" + page2 + "&pNo=" + pNo + "'>▶</a>");
		}

...
public class ProductInsertWithNoThumbnailCommand implements Command {
	...
	public void execute(SqlSession sqlSession, Model model) {
		...
		try {
			...
			pDAO.insertProductWithNoThumbnail(pName, pPrice, pCategory, pGender, pCompany, saveFilename2, pDescription, pStock1, pStock2, pStock3);

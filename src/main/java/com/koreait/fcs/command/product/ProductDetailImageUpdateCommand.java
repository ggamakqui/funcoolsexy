...
public class ProductDetailImageUpdateCommand implements Command {
	...
	public void execute(SqlSession sqlSession, Model model) {
		...
		try {
			...
			pDAO.productDetailImageUpdate(pName, pPrice, pCategory, pGender, pCompany, saveFilename2, pDescription, pStock1, pStock2, pStock3, pNo);
